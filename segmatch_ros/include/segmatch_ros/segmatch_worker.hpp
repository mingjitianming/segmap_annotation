...
/**************************************************************************/
#include <segmatch_ros/TempExportMap.h>
/****************************************************************************/
...
class SegMatchWorker {
 ...
 private:
  ...
  /****************************************************************************************/
   ros::ServiceServer temp_export_map_;
   bool tempExportMap(segmatch_ros::TempExportMap::Request& req, segmatch_ros::TempExportMap::Response& res);
  /*****************************************************************************************/
