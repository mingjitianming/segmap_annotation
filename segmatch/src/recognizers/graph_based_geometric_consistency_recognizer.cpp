...
// 主要更新 candidate_transfomations_  candidate_matches_
void GraphBasedGeometricConsistencyRecognizer::recognize(
  ...
  std::vector<size_t> maximum_clique =  GraphUtilities::findMaximumClique(        // TODO ZMY:未看代码，有论文  
  ...
  candidate_matches_.emplace_back();                       // std::vector<PairwiseMatches> candidate_matches_
  ...
  candidate_transfomations_.push_back(transformation);                                    // 坐标变换
}
