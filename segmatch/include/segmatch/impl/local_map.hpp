...
// segmatch::LocalMap<segmatch::PclPoint, segmatch::MapPoint>
...
void LocalMap<InputPointT, ClusteredPointT>::updatePoseAndAddPoints(
  ...
  std::vector<bool> is_point_removed = updatePose(pose);   // 移除当前位姿圆柱外侧的点，并返回是否被移除的vector
